...
public class MongoDecoder
{
    ...
    public LocalDateTime readLocalDateTime( String pAttribute ) {
        String tDateTimeString = mDoc.getString( pAttribute );
        return DateUtils.stringToLocalDateTime( tDateTimeString );
    }

    public LocalDate readLocalDate( String pAttribute ) {
    ...
    public Float readFloat( String pAttribute ) {
        return mDoc.getDouble( pAttribute ).floatValue();
    }
    ...
    public List<LocalDate> readLocalDateArray( String pAttribute, String pListType) {
    ...
    public List<LocalDateTime> readLocalDateTimeArray( String pAttribute, String pListType) {
        List<String> tRetLst = (List<String>) mDoc.get( pAttribute );
    ...
    public List<Float> readFloatArray( String pAttribute, String pListType) {
        List<Double> tDoubleList = (List<Double>) ListFactory.convertList((List<Double>)mDoc.get( pAttribute ), pListType);
        if (tDoubleList == null) {
            return null;
        }
        List<Float> tFloatList = ListFactory.getList( pListType );
        for( Double d : tDoubleList ) {
            tFloatList.add( d.floatValue() );
        }
        return tFloatList;
    }
    ...
    public List<Map<String,String>> readMapArray( String pAttribute, String  pListType) {
       ...
       List<Map<String,String>> tMapLst = ListFactory.getList(pListType);
