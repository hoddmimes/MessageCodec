...
public class MongoEncoder
{
    ...
    public void add( String pAttribute, Float pValue ) {
        mDoc.append( pAttribute, (double) pValue);
    }
    ...
    public void addFloatArray( String pAttribute, List<Float> pList ) {
        mDoc.append( pAttribute, pList );
    }
    ...
    public void addLocalDateArray( String pAttribute, List<LocalDate> pList ) {
        if (pList == null) {
            return;
        }
    ...
    public void addLocalDateTimeArray( String pAttribute, List<LocalDateTime> pList ) {
        if (pList == null) {
            return;
        }
        ArrayList<String> tDateLst = new ArrayList<>();
