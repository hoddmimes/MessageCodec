...
public class TestMessageBase implements MessageInterface, MessageMongoInterface {
    ...
    public String toString(int pCount, boolean pExtention) {
        ...
        if (pExtention) {
            tSB.append("<Extending Message: " + "\"TestMessageBase\"  Id: " + Integer.toHexString(getMessageId()) + ">\n");
        } else {
            tSB.append("Message: " + "\"TestMessageBase\"  Id: " + Integer.toHexString(getMessageId()) + "\n");
        }


        // FormatNative name: mBaseString array-type:
        tSB.append(blanks(pCount + 2) + "mBaseString: ");
        tSB.append(mBaseString);
        tSB.append("\n");
    ...
    public static class Builder {
        private final TestMessageBase mInstance;
