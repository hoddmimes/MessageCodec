...
public class TestMessage extends TestMessageBase
    implements MessageInterface, MessageMongoInterface {
  ...
  public TestMessage setMsgList(List<TestSubMessage> pMsgList) {
    ...
    if (mMsgList == null) mMsgList = ListFactory.getList("array");
  ...
  public String toString(int pCount, boolean pExtention) {
    ...
    if (pExtention) {
      ...
      tSB.append(
          "Message: " + "\"TestMessage\"  Id: " + Integer.toHexString(getMessageId()) + "\n");
    }
