<xsl:stylesheet version="3.0"
	...
	<xsl:variable name="TypeTableDefinitions">
		<DataTypes>
			...
			<Type name="float" type="Float" arrayEncoder="addFloatArray" arrayDecoder="readFloatArray" decoder="readFloat" />
...
<xsl:template mode="generateMessageFactory" match="Messages">
	...
	<xsl:variable name="moduleName" select="functx:substring-before-if-contains($inputXml,'.')"/>
...
import com.hoddmimes.msgcompiler.messaging.*;
...
import com.hoddmimes.msgcompiler.messaging.MessageBinDecoder;
import com.hoddmimes.msgcompiler.messaging.MessageBinEncoder;
import com.hoddmimes.msgcompiler.messaging.MessageInterface;
import com.hoddmimes.msgcompiler.messaging.MessageAux;
import com.hoddmimes.msgcompiler.messaging.MessageInterface;
import com.hoddmimes.msgcompiler.messaging.MessageWrapper;
